  ...
  return (
    <div className="max-w-[1400px] mx-auto px-6 py-8" onClick={() => setOpenMenu(null)}>
      <div className="mb-6">
        ...
        <p className="text-sm text-stone-600 mt-1">{filtered.length}건 표시 중</p>
      </div>
